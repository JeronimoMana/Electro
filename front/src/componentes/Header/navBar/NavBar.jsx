...
const NavBar = () => {
    ...
    return (
        <div className={`container-fluid p-0 ${width > 500 ? "sticky-top" : ""} ${style.bg}`}>
            <div className={`container-xxl ${style.nav_container} ${style.bg} ${width < 640 ? "d-none" : ""}`}>
                <ul className={`nav float-start `}>
                    <li className="nav-item" >
                        <p className={`nav-link ${style.bg_text}`}><svg className={style.m_svg} xmlns="http://www.w3.org/2000/svg" height="12" width="12" viewBox="0 0 512 512"><path fill="#ff0000" d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.2 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z" /></svg>+54 03516830927</p>
                    </li>
            ...
            <div className={` ${style.nav_container}`}>
                <div className={`container-xxl d-flex justify-content-between align-items-center`}>
                    ...
                    {width < 640 ?
                        <div>
                            <button className="navbar-toggler me-4 mb-3" type="button" >
