                            ...
                            {toggler ?
                                <div class="row" >
                                    <ul class={`navbar-nav ms-3 ${style.hamburguesa}`}>
                                        <li class="nav-item text-white" onClick={handleModal}>
                                        ...
                                        <li class="nav-item">
                                            <NavLink to="/lista_deseos" className="text-white">
                                        ...
                                        <li class="nav-item">
                                            <NavLink to="/shopping_cart" className="text-white">
                                ...
                                <li className={`d-flex flex-column align-items-center ${style.wdt_shop} m-2`}>
                                    <NavLink to="/shopping_cart">
                                        <div className={`position-relative d-flex justify-content-center`}>
                                            ...
                                            <span className="position-absolute top-0 end-0 translate-middle badge rounded-pill  p-1 border">
